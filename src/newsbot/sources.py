...
RSS_SOURCES: list[NewsSource] = [
    ...
    google_news_source("CMoney", "site:cmoney.tw 券商 OR 證券商 OR 金管會 OR 交易制度 OR 零股 OR 複委託"),
    google_news_source("moomoo", "site:moomoo.com brokerage strategy OR broker expansion OR trading platform launch", lang="en-US", region="US"),
